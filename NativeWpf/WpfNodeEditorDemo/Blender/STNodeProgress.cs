...
namespace WinNodeEditorDemo.Blender
{
    ...
    public class STNodeProgress : STNodeControl
    {
        ...
        protected override void OnMouseDown(STNodeMouseEventArgs e) {
            base.OnMouseDown(e);
            m_bMouseDown = true;
        }

        protected override void OnMouseUp(STNodeMouseEventArgs e) {
            base.OnMouseUp(e);
            m_bMouseDown = false;
        }

        protected override void OnMouseMove(STNodeMouseEventArgs e) {
            base.OnMouseMove(e);
